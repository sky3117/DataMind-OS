        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-12">
            ...
            <p className="text-sm text-slate-400 mb-6">
              Upload a file to run specialized AI agents for data cleaning, analysis, reporting, and prediction.
            </p>
            <Link
              href="/upload"
          ...
          <div className="flex items-center justify-between h-16">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-0.5">
                Analyzing <span className="text-slate-200 font-medium">{filename}</span>
              </p>
            </div>
