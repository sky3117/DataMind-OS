        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-12">
            ...
            <p className="text-sm text-slate-400 mb-6">
              Upload a file to build visual data processing pipelines with filters, transforms, aggregations, and more.
            </p>
            <Link
              href="/upload"
      ...
      <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div>
              <h1 className="text-2xl font-bold text-slate-100">Pipeline Builder</h1>
